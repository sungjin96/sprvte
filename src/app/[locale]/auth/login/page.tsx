...
export default function LoginPage() {
  ...
  const [error, setError] = useState(
    callbackError === 'auth_callback_failed' ? t('errors.callbackFailed') : '',
  );
    ...
    <div className="space-y-6">
      ...
      <GlassPanel level="raised" className="p-6 space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <FormField label={t('password')} htmlFor="password" error={error || undefined}>
            <Input
              id="password"
              type="password"
          ...
          <div className="flex justify-end">
            <Link
              ...
              className="text-[12px] text-[var(--text-3)] hover:text-[var(--text-2)] transition-colors"
            >
              {t('forgotPassword')}
            </Link>
          </div>
